...
* `a and b`
"""
# numbers = map(int,input('숫자 두 개를 입력하세요 :').split())
# n1, n2 = numbers
# print(n1, n2)
# print("n1 > 10 : ", n1 > 10)
# print("n2 < 10 : ", n2 < 10)
# print ("n1 > 10 and n2 < 10 :",  n1 > 10 and n2 < 10)
# print("n1 * 2 > 10 and n2 - 5 < 10 :", n1 * 2 > 10 and n2 - 5 < 10)
...
"""
print("1. 끝점만 list(range(10))", list(range(10)))
print("2. 시작점 * 끝점 list(range(5,10))", list(range(5,10)))
print("3. 시작점 * 끝점 * 증감폭 list(range(5,10,2))", list(range(5,10,2)))
print("4. 시작점 * 끝점 * 증감폭 list(range(10,5,-2))", list(range(10,5,-2)))
